...
public class SampleRSAEncryptAndDecrypt
{
    ...
    static private void doGenkey(String[] args) throws NoSuchAlgorithmException, IOException {
        if ( args.length == 0 ) {
    ...
    static private void doEncrypt(String[] args)
            throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, BadPaddingException, InvalidKeyException, IllegalBlockSizeException, IOException{
        if ( args.length != 2 ) {
